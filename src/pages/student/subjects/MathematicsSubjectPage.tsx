...
const levels: GameLevel[] = [
  {
    ...
    status: "completed",
    stars: 3,
    route: "/student/mathematics/level/1"
  },
  {
    id: "2",
    level: 2,
    name: "Profit, Loss & Measurement",
    description: "Learn practical math for real-world business scenarios",
    game: "Shopkeeper Simulator",
    xp: 150,
    coins: 35,
    status: "completed",
    stars: 2,
    route: "/student/mathematics/level/2"
  },
  {
    id: "3",
    level: 3,
    name: "Logic & Problem Solving",
    description: "Advanced puzzles and mathematical reasoning",
    game: "Logic Master",
    xp: 200,
    coins: 50,
    status: "available",
    route: "/student/mathematics/level/3"
  }
];
...
export default function MathematicsSubjectPage() {
  ...
  return (
    <AppLayout role="student" playCoins={1250} title="Mathematics">
          ...
          <div className="glass-card rounded-2xl p-5 border border-border bg-gradient-to-br from-badge/20 to-badge/5">
            <div className="flex items-center gap-4 mb-4">
              <div className="h-16 w-16 rounded-2xl bg-badge/30 flex items-center justify-center">
                <Calculator className="h-8 w-8 text-badge" />
              </div>
              <div className="flex-1">
                <h2 className="font-heading text-2xl font-bold text-foreground">Mathematics</h2>
                <p className="text-sm text-muted-foreground">Numbers, logic & calculations</p>
              </div>
            </div>
