...
const levels: GameLevel[] = [
  {
    ...
    game: "Reaction Builder",
    xp: 100,
    coins: 25,
    status: "available",
    route: "/student/chemistry/level/1"
  },
  {
    id: "chemistry-2",
    level: 2,
    ...
    coins: 35,
    status: "available",
    route: "/student/chemistry/level/2"
  },
  {
    id: "chemistry-3",
    level: 3,
    ...
    coins: 50,
    status: "available",
    route: "/student/chemistry/level/3"
  },
  {
    id: "chemistry-4",
    level: 4,
    ...
    coins: 60,
    status: "available",
    route: "/student/chemistry/level/4"
  },
  {
    id: "chemistry-5",
    level: 5,
    ...
    game: "Lab Safety Hero",
    xp: 300,
    coins: 75,
    status: "available",
    route: "/student/chemistry/level/5"
  }
];
      ...
      <div className="px-4 py-6 pb-24">
        ...
        <div className="space-y-4">
          {levels.map((level, index) => (
            <Card
              key={level.id}
              className={`glass-card border p-4 slide-up ${level.status === "locked" ? "border-border opacity-60" : "border-secondary/30"
                }`}
              style={{ animationDelay: `${100 + index * 75}ms` }}
            >
              <div className="flex items-start gap-4">
                <div className={`h-14 w-14 rounded-xl flex items-center justify-center shrink-0 ${level.status === "completed"
                    ? "bg-secondary"
                ...
                <div className="flex-1">
                  ...
                  {level.status === "completed" && level.stars && (
                    <div className="flex items-center gap-1 mt-2">
                      {[1, 2, 3].map((star) => (
                        <Star
                          key={star}
                          className={`h-5 w-5 ${star <= level.stars! ? "text-accent fill-accent" : "text-muted-foreground"
                            }`}
                        />
                      ))}
                    </div>
                  ...
                  {level.status !== "locked" && (
                    <Button
                      ...
                      className={`mt-3 w-full ${level.status === "completed"
